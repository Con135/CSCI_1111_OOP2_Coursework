...
public class Text_GUI extends Application {
		...
		public void start(Stage primaryStage) {
			...
			btRed.setToggleGroup(togGroup);
			btYellow.setToggleGroup(togGroup);
			btBlack.setToggleGroup(togGroup);
			btOrange.setToggleGroup(togGroup);
			btGreen.setToggleGroup(togGroup);
